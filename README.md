...
#### A guide covering Android including the applications, libraries and tools that will make you a better and more efficient Android developer.

**Note: You can easily convert this markdown file to a PDF in [VSCode](https://code.visualstudio.com/) using this handy extension [Markdown PDF](https://marketplace.visualstudio.com/items?itemName=yzane.markdown-pdf).**

# Table of Contents

1. [Android Learning Resources](https://github.com/mikeroyal/Android-Guide#android-learning-resources)
...
5. [Java Development](https://github.com/mikeroyal/Android-Guide#java-development)

6. [Kotlin Development](https://github.com/mikeroyal/Android-Guide#kotlin-development)

7. [C/C++ Development](https://github.com/mikeroyal/Android-Guide#cc-development)

8. [C# Development](https://github.com/mikeroyal/Android-Guide#c-development)

9. [Python Development](https://github.com/mikeroyal/Android-Guide#python-development)
...
[Back to the Top](https://github.com/mikeroyal/Android-Guide#table-of-contents)

[Android](https://www.android.com/) is a mobile operating system developed by Google. The Operating System(OS) is based on a modified version of the [Linux kernel](https://www.redhat.com/en/topics/linux/what-is-the-linux-kernel) and other open source software for smartphones and tablets.

[Android Open Source Project (AOSP)](https://source.android.com/) is a  repository that offers the information and source code needed to create custom variants of the Android OS, port devices and accessories to the Android platform, and ensure devices meet the compatibility requirements that keep the Android ecosystem a healthy and stable environment for millions of users.

[AndroidX](https://developer.android.com/jetpack/androidx/) is a major improvement to the original Android Support Library, which is no longer maintained. androidx packages fully replace the Support Library by providing feature parity and new libraries. In addition, AndroidX includes the following features: All packages in AndroidX live in a consistent namespace starting with the string androidx.
...
[Start Developing Android Apps with Xamarin.Android](https://docs.microsoft.com/en-us/xamarin/android/get-started/)

[Google Developers Training](https://developers.google.com/training/)

[Google Developers Certification](https://developers.google.com/certification/)

[Training Courses for Android Developers](https://developer.android.com/courses/)

[Codelabs for Android Developer Fundamentals](https://developer.android.com/courses/fundamentals-training/toc-v2)

[Learning Kotlin for Android](https://developer.android.com/kotlin/campaign/learn)

[Associate Android Developer Certification](https://grow.google/androiddev/)

[Top Android Courses on Coursera](https://www.coursera.org/courses?query=android)

[Top Android Development Courses on Udemy](https://www.udemy.com/topic/android-development/)

[Android Developer Nanodegree on Udacity](https://www.udacity.com/course/new-android-fundamentals--ud851)

[Learn Android Development with Online Courses on edX](https://www.edx.org/learn/android-development)

# Getting Software and Apps on Android
[Back to the Top](https://github.com/mikeroyal/Android-Guide#table-of-contents)

[Google Play Store](https://play.google.com/store) is Google's digital app center similar to Apple's App Store. Where you can  millions of the latest Android apps, games, music, movies, TV, books, magazines & more all across your devices.
...
[ML Manager](https://play.google.com/store/apps/details?id=com.javiersantos.mlmanager&hl=en_US&gl=US) is a customizable APK manager for Android: extract any installed app, mark them as favorite, share.apk files easily and much more. 
...
[Mediapipe](https://mediapipe.dev/) is a framework for customizable Machine Learning(ML) solutions for live and streaming media.

[Filament](https://google.github.io/filament/) is a real-time physically based rendering engine for Android, iOS, Windows, Linux, macOS, and WebGL 2.
...
[Expo](https://docs.expo.io/) is an open-source platform for making universal native apps that run on Android, iOS, and the web. It includes a universal runtime and libraries that let you build native apps by writing React and JavaScript.

[Glide](https://bumptech.github.io/glide/) is a fast and efficient open source media management and image loading framework for Android that wraps media decoding, memory and disk caching, and resource pooling into a simple and easy to use interface.

[Lottie](http://airbnb.io/lottie/) is a mobile library for Android and iOS that parses [Adobe After Effects](http://www.adobe.com/products/aftereffects.html) animations exported as json with [Bodymovin](https://github.com/airbnb/lottie-web) and renders them natively on mobile.

[Material design icons](https://fonts.google.com/icons) is the official icon set from Google. The icons are designed under the [material design guidelines](https://material.io/guidelines/).

[NativeScript](https://nativescript.org/) is an pen-source framework that allows you to access native APIs from JavaScript directly. The framework currently provides iOS and Android runtimes for rich mobile development and can be utilized in a number of diverse use cases.

[Quasar](https://quasar.dev/) is a framework for building high-performance VueJS user interfaces in record time: responsive Single Page Apps, SSR Apps, PWAs, Browser extensions, Hybrid Mobile Apps and Electron Apps.
...
- [x] If would you like to contribute to this guide simply make a [Pull Request](https://github.com/mikeroyal/Android-Guide/pulls).
